...
& > & 0 \nonumber
\end{eqnarray}
with the third equation numbered in the margin but not the others, 
use \bgn{eqnarray}, \nd{eqnarray} 
...
text appear as large as it would in a displayed equation. 
...
in text looks smaller: $\frac{a}{b+c}$.
...
remarks, and so on.  The file {\tt math27842794Wpaper.tex} has included special 
...
$$
Similarly, products (if you need them) are typed as \pln{prod}, not as \pln{Pi}, 
{\it e.g.},
$$
n! = \prod_{j = 1}^n j.
$$
